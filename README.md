...
1. Download or clone this [repostory](https://github.com/M-Anwar-Hussaini/Book-Store).
...
- Clone this [repository](https://github.com/M-Anwar-Hussaini/Book-Store) to your desired folder:

- Example commands:

```sh
  cd [YOUR FOLDER]
  git clone https://github.com/M-Anwar-Hussaini/Book-Store.git
```
...
Feel free to check the [issues page](https://github.com/M-Anwar-Hussaini/Book-Store/issues).
...
If you like this project, kindly drop a start for the [repository](https://github.com/M-Anwar-Hussaini/Book-Store);
